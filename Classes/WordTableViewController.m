...
//    if ([[AllData sharedAllData].history count] > (round + 1)) {
//        [[AllData sharedAllData].history removeObjectsInRange:NSMakeRange([[AllData sharedAllData].history count], [[AllData sharedAllData].history count] - (round + 1))];
//    }
    
    self.dataArray = [AllData sharedAllData].history;
    self.title = @"History";
}
